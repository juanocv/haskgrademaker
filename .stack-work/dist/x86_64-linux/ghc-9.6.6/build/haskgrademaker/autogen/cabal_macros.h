...
/* package haskgrademaker-0.1.0.0 */
#ifndef VERSION_haskgrademaker
#define VERSION_haskgrademaker "0.1.0.0"
#endif /* VERSION_haskgrademaker */
#ifndef MIN_VERSION_haskgrademaker
#define MIN_VERSION_haskgrademaker(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskgrademaker */
